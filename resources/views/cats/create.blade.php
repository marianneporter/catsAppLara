            ...
            <form method="post" action="">
                ...
                <div class="mb-2">
                    ...
                    <input type="text" id="name" name="name"
                           class="input-element" placeholder="Cat's Name" required>
                </div>
                ...
                <div class="mb-2">
                    ...
                    <div class="relative max-w-sm">
                        ...
                        <input datepicker datepicker-format="dd M yyyy" type="text" class="input-element datepicker-element" placeholder="Select date" name="dob">
                    </div> 
                </div>  
                ...
                <div class="mb-2">
                    ...
                    <select id="colour" class="input-element">
                ...
                <div class="mb-2">
                    ...
                    <select id="fav-food" class="input-element">
