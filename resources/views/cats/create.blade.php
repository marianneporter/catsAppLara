            ...
            <form method="post" action="" autocomplete="off">
                ...
                <div class="mb-2">
                    ...
                    <input type="text" id="name" name="name"
                           class="input-element px-2.5" placeholder="Cat's Name" required>
                </div>
                ...
                <div class="mb-2">
                    ...
                    <div class="relative max-w-sm">
                        ...
                        <input id="datepickerId" type="text" class="input-element px-10" placeholder="Select date" name="dob">
                    </div> 
                </div>  
                ...
                <div class="mb-2">
                    ...
                    <select id="colour" class="input-element px-2.5">
                ...
                <div class="mb-2">
                    ...
                    <select id="fav-food" class="input-element px-2.5">
